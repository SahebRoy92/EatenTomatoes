...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        CGRect mainRect = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight) options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading) attributes:@{NSFontAttributeName:self.titleLabel.font} context:nil];
...
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        ...
        CGSize titleSize = mainRect.size;
        
         CGRect subRect = [self.subtitleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight) options:(NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading) attributes:@{NSFontAttributeName:self.subtitleLabel.font} context:nil];
